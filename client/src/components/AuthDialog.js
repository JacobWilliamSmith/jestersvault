...
export default function AuthDialog(props) {
  ...
  const onRegChange = (e) => {
    if (e.target.name === "password") {
      setErrors({
        ...errors,
        [e.target.name]: validateInput(e.target.name),
  ...
  const validateInput = (fieldName) => {
    ...
    switch (fieldName) {
      case "username":
        if (refRegUsername !== null && refRegUsername.current !== null) {
          input = refRegUsername.current.value;
        }
        if (input === "" || input === undefined || input === null) {
          return "Username is required";
        }
        if (input.length < 4) {
          return "Username is too short (must be at least 4 characters)";
        }
        if (input.length > 32) {
          return "Username is too long (must be at most 32 characters)";
        }
      ...
      case "email":
        if (refRegEmail !== null && refRegEmail.current !== null) {
          input = refRegEmail.current.value;
        }
        if (input === "" || input === undefined || input === null) {
      ...
      case "password":
        if (refRegPassword !== null && refRegPassword.current !== null) {
          input = refRegPassword.current.value;
        }
        if (input === "" || input === undefined || input === null) {
      ...
      case "confPass":
        if (refRegConfPass !== null && refRegConfPass.current !== null) {
          input = refRegConfPass.current.value;
        }
        let password = "";
        if (refRegPassword !== null && refRegPassword.current !== null) {
              ...
              <Box sx={{ p: 1 }}>
                <DialogContent>
                  <TextField
                    ...
                    helperText={
                      showErrors["username"] && errors["username"] !== null
                        ? errors["username"]
                        : " "
                    }
                    autoFocus
                  ...
                  <TextField
                    ...
                    fullWidth
                    color={
                      showErrors["email"] ? (errors["email"] === null ? "success" : "error") : null
                    }
                    error={showErrors["email"] && errors["email"] !== null}
                    helperText={
                      showErrors["email"] && errors["email"] !== null ? errors["email"] : " "
                    }
                  />

                  <TextField
                    inputRef={refRegPassword}
                    name="password"
                    type="password"
                    label="Password"
                    onChange={onRegChange}
                    ...
                    helperText={
                      showErrors["password"] && errors["password"] !== null
                        ? errors["password"]
                        : " "
                    }
                  />
                  ...
                  <TextField
                    ...
                    helperText={
                      showErrors["confPass"] && errors["confPass"] !== null
                        ? errors["confPass"]
                        : " "
                    }
                  />
