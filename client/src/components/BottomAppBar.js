  ...
  return (
    <Box>
      <AppBar position="fixed" sx={{top: 'auto', bottom: 0 }}>
          { inEncounter
          ? <Box>
              <CustomButton title="Previous Turn" width="30%" imageUrl="" onClick={() => {(dispatch(previousTurn(characters)))}} />
              <CustomButton title="End Encounter" width="40%" imageUrl="" onClick={() => {(dispatch(endEncounter()))}} />
              <CustomButton title="Next Turn" width="30%" imageUrl="" onClick={() => {(dispatch(nextTurn(characters)))}} />
            </Box>
          : <Box>
              <CustomButton title="Start Encounter" width="100%" imageUrl="" onClick={() => {(dispatch(startEncounter(characters)))}} />
            </Box>
          }
      </AppBar>
    </Box>
